...
export const ROUTES: any = {
    ...
    GET_MODES: `${API_URL}/hmsweb/users/devices/automation/active`,
    DELETE_MODE: `${API_URL}/hmsweb/users/locations/`,
    ...
    START_STREAM: `${API_URL}/hmsweb/users/devices/startStream`,
